...
$(document).on('click', '.house-adress-location', function(e){
    ...
    $.post('http://rw-phone/SetGPSLocation', JSON.stringify({
...
$(document).on('click', '.appartment-adress-location', function(e){
    ...
    $.post('http://rw-phone/SetApartmentLocation', JSON.stringify({
...
$(document).on('click', '.confirm-search-person-test', function(e){
    ...
    if (SearchName !== "") {
        $.post('http://rw-phone/FetchSearchResults', JSON.stringify({
            input: SearchName,
        }), function(result){
            if (result != null) {
                $(".person-search-results").html("");
                ...
                RL.Phone.Notifications.Add("politie", RL.Phone.Functions.Lang("MEOS_TITLE"), RL.Phone.Functions.Lang("MEOS_NORESULT"));
                $(".person-search-results").html("");
            }
        });
    } else {
...
$(document).on('click', '.confirm-search-person-house', function(e){
    ...
    if (SearchName !== "") {
        $.post('http://rw-phone/FetchPlayerHouses', JSON.stringify({
            input: SearchName,
        }), function(result){
            if (result != null) {
                $(".person-search-results").html("");
...
$(document).on('click', '.confirm-search-vehicle', function(e){
    ...
    if (SearchName !== "") {
        $.post('http://rw-phone/FetchVehicleResults', JSON.stringify({
            input: SearchName,
        }), function(result){
            if (result != null) {
                $(".vehicle-search-results").html("");
...
$(document).on('click', '.scan-search-vehicle', function(e){
    e.preventDefault();
    $.post('http://rw-phone/FetchVehicleScan', JSON.stringify({}), function(vehicle){
        if (vehicle != null) {
            $(".vehicle-search-results").html("");
            var APK = "Ja";
            if (!vehicle.status) {
            ...
            RL.Phone.Notifications.Add("politie", RL.Phone.Functions.Lang("MEOS_TITLE"), RL.Phone.Functions.Lang("NO_VEHICLE"));
...
$(document).on('click', '.meos-recent-alert', function(e){
    ...
    if (alertData.coords != undefined && alertData.coords != null) {
        $.post('http://rw-phone/SetAlertWaypoint', JSON.stringify({
            alert: alertData,
        }));
    } else {
        RL.Phone.Notifications.Add("politie", RL.Phone.Functions.Lang("MEOS_TITLE"), RL.Phone.Functions.Lang("MEOS_GPS"));
    }
});
...
$(document).on('click', '.meos-clear-alerts', function(e){
    ...
    RL.Phone.Notifications.Add("politie", RL.Phone.Functions.Lang("MEOS_TITLE"), RL.Phone.Functions.Lang("MEOS_CLEARED"));
});