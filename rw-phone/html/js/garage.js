...
SetupGarageVehicles = function(Vehicles) {
    ...
    if (Vehicles != null) {
        $.each(Vehicles, function(i, vehicle){
            var Element = '<div class="garage-vehicle" id="vehicle-'+i+'"> <span class="garage-vehicle-firstletter">'+vehicle.garage+'</span> <span class="garage-vehicle-name">'+vehicle.fullname+'</span> </div>';
